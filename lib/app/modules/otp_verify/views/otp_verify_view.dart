...
class MobileNumber {
  String number;
  MobileNumber({required this.number});
}
          ...
          return SafeArea(
            child: Stack(
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: customButton(
                                onTap: controller.otpConfirm
                                    ? () async {
                                        List otp = [];
                                        controller.otpControllers
                                            .forEach((element) {
                                          otp.add(element.text);
                                        });
                                        log('========length=====${otp.join()}====${argument.number}');
                                        await controller.verifyOtp(
                                            phoneNumber: argument.number,
                                            otpNumber: otp.join());
                                      }
                                    : () {},
                ...
                controller.verifyOtpLoading == true
