...
class CrateEventView extends GetView<CrateEventController> {
  const CrateEventView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<CrateEventController>(
      builder: (controller) {
        return Scaffold(
                ...
                if (controller.about.isEmpty ||
                  ...
                  Get.to(
                    EventDetailView(
                      ...
                      name: controller.albumNameController.text,
                      date: controller.dateController.text,
                      description: controller.aboutEventController.text,
                    ),
                  );
                }
              },
