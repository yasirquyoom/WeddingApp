...
class PhotographerYouSharedTabView extends GetView<EventDetailController> {
  const PhotographerYouSharedTabView({Key? key}) : super(key: key);
  @override
          ...
          itemBuilder: (context, index) {
            return index == 0
                ? AddMediaButtonWidget(
                    ...
                    // imagePath: controller.media[index - 1],
                    // index: index,
                  )
                : GestureDetector(
                    onLongPress: () {
